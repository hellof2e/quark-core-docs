      ...
      <div class="container">
        ...
        <div class="toper-bar">
                ...
                <div class="menu-wrap">
                  <div class="menu-items">
                    <div class="menu-item-group">
                      ...
                      <a
                        v-for="item in ecosystemLangs.stacks"
                        :key="item"
                        class="link menu-link"
                        :href="`https://quark-ecosystem.github.io/quarkd-docs/${item.toLowerCase()}`"
                        target="_blank"
          ...
          <div class="social-links">
            ...
            <a href="{this.githubUrl}" class="github-link" target="_blank">
...
export default defineComponent({
  ...
  setup() {
    ...
    return {
      ...
      docs: reactive(docs),
      ecosystemLangs: isZhLang ? langs["zh-CN"] : langs["en-US"],
      curHost: location.origin,
      guideUrl: `${location.origin}${location.pathname}#/${localStorage.getItem(
        "language"
      )}/guide/quickstart`,
    };
  },
...
.nav-item button {
  color: var(--text-font-color-light, rgba(60, 60, 67, 0.92));
  font-family: var(--font-family-base);
...
.logo {
  width: 160px;
  height: 40px;
  --logo-light-mode: url(https://m.hellobike.com/resource/helloyun/13459/Dc16h_quarkc-dark.png?x-oss-process=image/quality,q_80);
